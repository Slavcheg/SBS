  ...
  return (
    ...
    >
      {userStore2.trainers
        .filter(trainer =>
          searchStream !== ""
            ? (trainer.item.first + trainer.item.last || trainer.item.email)
                .toLocaleLowerCase()
                .includes(searchStream.toLocaleLowerCase())
            : true,
        )
        .map((user, key) => {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <Text key={key} style={[{ color: "black", marginLeft: "5%" }]}>
                    {nickname}
                  </Text>
                </View>
              </TouchableHighlight>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <FontAwesomeIcon icon={faPlusCircle} color={color.palette.green_sbs} size={60} />
        </TouchableOpacity>
      </View>
