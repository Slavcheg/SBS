...
export const TrainingProgramsScreen: React.FunctionComponent<ProgramsScreenProps> = observer(
  props => {
    ...
    const onPressEditProgramHandler = editIndex => {
      console.log("tried editing program ", programsStore.programs[editIndex].id)
      navigation.navigate("EditProgramScreen", { programID: programsStore.programs[editIndex].id })
    }
